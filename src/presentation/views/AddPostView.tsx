...
import { Camera, Image as ImageIcon, ArrowRight } from 'lucide-react-native';
...
export const AddPostView: React.FC<AddPostViewProps> = ({ onMenu }) => (
  <View style={styles.container}>
    ...
    <View style={styles.form}>
      ...
      <Button style={{ marginTop: 16 }} icon={<ArrowRight size={20} color="white" />}>Publicar Anúncio</Button>
    </View>
  </View>
);
...
const styles = StyleSheet.create({
  ...
  addMediaBtn: { flex: 1, aspectRatio: 1, backgroundColor: '#f8fafc', borderSize: 2, borderStyle: 'dashed', borderColor: '#e2e8f0', borderRadius: 32, alignItems: 'center', justifyContent: 'center', gap: 8 },
  addMediaText: { fontSize: 10, fontWeight: '800', color: '#94a3b8', letterSpacing: 1.5 },
  form: { gap: 16 },
});
